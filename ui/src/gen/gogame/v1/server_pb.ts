...
export class Move extends Message<Move> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "undone", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
...
export class CreateGameRequest extends Message<CreateGameRequest> {
  ...
  /**
   * @generated from field: int32 move_duration_sec = 3;
   */
  moveDurationSec = 0;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "move_duration_sec", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);
 ...
 */
export class Undo extends Message<Undo> {
  /**
   * @generated from field: string game_id = 1;
   */
  gameId = "";
  ...
  constructor(data?: PartialMessage<Undo>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gogame.v1.Undo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "game_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "game_rev", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "player_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "move", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 5, name: "decided", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 6, name: "accepted", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Undo {
    return new Undo().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Undo {
    return new Undo().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Undo {
    return new Undo().fromJsonString(jsonString, options);
  }

  static equals(a: Undo | PlainMessage<Undo> | undefined, b: Undo | PlainMessage<Undo> | undefined): boolean {
    return proto3.util.equals(Undo, a, b);
  }
}
...
export class UndoRequest extends Message<UndoRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "game_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "game_rev", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "request", kind: "message", T: UndoRequest_Request, oneof: "action" },
    { no: 4, name: "decision", kind: "message", T: UndoRequest_Decision, oneof: "action" },
  ]);
 ...
 */
export class UndoRequest_Request extends Message<UndoRequest_Request> {
  /**
   * @generated from field: string player_id = 3;
   */
  playerId = "";

  constructor(data?: PartialMessage<UndoRequest_Request>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gogame.v1.UndoRequest.Request";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 3, name: "player_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UndoRequest_Request {
    return new UndoRequest_Request().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UndoRequest_Request {
    return new UndoRequest_Request().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UndoRequest_Request {
    return new UndoRequest_Request().fromJsonString(jsonString, options);
  }

  static equals(a: UndoRequest_Request | PlainMessage<UndoRequest_Request> | undefined, b: UndoRequest_Request | PlainMessage<UndoRequest_Request> | undefined): boolean {
    return proto3.util.equals(UndoRequest_Request, a, b);
  }
}
 ...
 */
export class UndoRequest_Decision extends Message<UndoRequest_Decision> {
  /**
   * @generated from field: string player_id = 3;
   */
  playerId = "";
  ...
  constructor(data?: PartialMessage<UndoRequest_Decision>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gogame.v1.UndoRequest.Decision";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 3, name: "player_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "accepted", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UndoRequest_Decision {
    return new UndoRequest_Decision().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UndoRequest_Decision {
    return new UndoRequest_Decision().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UndoRequest_Decision {
    return new UndoRequest_Decision().fromJsonString(jsonString, options);
  }

  static equals(a: UndoRequest_Decision | PlainMessage<UndoRequest_Decision> | undefined, b: UndoRequest_Decision | PlainMessage<UndoRequest_Decision> | undefined): boolean {
    return proto3.util.equals(UndoRequest_Decision, a, b);
  }
}
